        ...
        <div class="row">
            ...
            <div class="col-12">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" rows="5" name="pro_desc"></textarea>
                </div>
                <div class="form-group">
                    <label for="">Chi tiết thông số</label>
                    <textarea class="form-control" rows="5" name="specification"></textarea>
                </div>
...
<?php echo $__env->make('admin.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Library/WebServer/Documents/WE3013.1-php2/mvc/app/views/admin/product/add-form.blade.php ENDPATH**/ ?>